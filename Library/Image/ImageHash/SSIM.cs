// from https://web.archive.org/web/20150629033652/http://www.lomont.org/Software/Misc/SSIM/SSIM.html
//
...
namespace Lomont
{
    internal class SSIM
    {
        ...
        private double ComputeSSIM(Grid img1, Grid img2)
        {
            ...
            return 100.0 * ssim_map.Total / (ssim_map.width * ssim_map.height);
        } // ComputeSSIM
        ...
        /// <param name="h"></param>
        /// <returns></returns>
        private static Grid ConvertLinear(ushort[] img, int w, int h)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private static Grid ConvertBitmap(Bitmap bmp)
        {
