// from https://github.com/perivar/CommonUtils/blob/master/Library/Source/BinaryFile.cs
...
namespace CommonUtils
{
    ...
    public class BinaryFile
    {
        ...
        public BinaryFile(string filePath)
            : this(filePath, ByteOrder.LittleEndian, false)
        {
        }

        public BinaryFile(string filePath, ByteOrder byteOrder)
            : this(filePath, byteOrder, false)
        {
        }
        ...
        public BinaryFile(byte[] byteArray)
            : this(byteArray, ByteOrder.LittleEndian)
        {
        }
        ...
        #endregion Set and Get Position
        ...
        #endregion Public Static Read Methods
