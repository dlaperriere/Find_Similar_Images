...
public class TestImageIndexMulti
{
    ...
    private string test_index0 = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../Test/images/images0.idx");
    private string test_index1 = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../Test/images/images1.idx");
